...
def naked_twins(values):
    ...
    # For every combination of twins, if they have the same value and share a
    # unit, we found a naked twin. Let's make a list for further processing
    naked_twins = [(box1, box2, unit1) for (box1, box2) in combinations(possible_twins, 2) \
                     for unit1 in units[box1] for unit2 in units[box2] \
                     if values[box1] == values[box2] and unit1 == unit2]

    for (box1, box2, unit) in naked_twins:
        for box in unit:
